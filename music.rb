...
if RUBY_PLATFORM.include?('mswin')
  ...
  class LiveMIDI
    ...
    module CF
      extend DL::Importable
      dlload '/System/Library/Frameworks/CoreMIDI.framework/Versions/Current/CoreFoundation'
    ...
    def message(*args)
      ...
      # Pass in two 32 bit 0s for the 64 bit time (OR one for 64 bit OS)
